...
public class CampaignKeywordReportService {
    ...
    public Map<String, Object> getCampaignKeywordReport(String userId, String md, String fromdate, String todate,
        ...
        return getKeywordTop(acc, md, fromdate, todate, comparefrom, compareto, kpi, campaignId);
    }
    ...
    private Map<String, Object> getKeywordTop(AccountDto acc, String md, String from, String to,
        ...
        for (String targetMd : getMdList(md)) {
            ...
            List<Map<String, Object>> stats = mongoService.aggregateByKeywordWithFilter(
                advid, from, to, cfg.dailyCol(), cfg.advField(), "campaign_id", campaignId);
            if (stats.isEmpty()) continue;

            List<Map<String, Object>> compStats = mongoService.aggregateByKeywordWithFilter(
                advid, cfrom, cto, cfg.dailyCol(), cfg.advField(), "campaign_id", campaignId);
