...
public class AdgroupAdReportService {
    ...
    public Map<String, Object> getAdgroupAdReport(String userId, String md, String fromdate, String todate,
        ...
        return getAdTop(acc, md, fromdate, todate, comparefrom, compareto, kpi, "adgroup_id", adgroupId);
    }
