...
public class KakaoSaTokenMongoService {

    private final MongoTemplate mongoTemplate;

    private static final String COLLECTION = "kakao_sa_token";
    private static final String TOKEN_KEY  = "kakaosa";
    ...
    // PHP kakaosa_access_token.php INSERT 필드 완전 동일
